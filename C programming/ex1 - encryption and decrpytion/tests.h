...
/**
 * Tests cyclic decode with lower case string that
 * include special character and positive k=2.
 * @return 0 upon success.
 */
int test_decode_cyclic_lower_case_special_char_positive_k ();

/**
 * Tests non-cyclic decode with lower case string that include special character and negative k=-1.
 * @return 0 upon success.
 */
